    ...
    <header className="absolute top-0 w-full bg-transparent z-50">
      <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center gap-5">
          ...
          <button className="px-3 py-2 bg-cyan-400 text-black font-semibold rounded hover:bg-cyan-300 transition-all">
            Log In
          </button>
        </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-black bg-opacity-90 text-white py-4 px-6 space-y-4">
